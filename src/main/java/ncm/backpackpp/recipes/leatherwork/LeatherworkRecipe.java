...
public class LeatherworkRecipe implements NcmRecipe<ImplementedInventory> {
    ...
    @Override
    public NcmRecipeSerializer<?> getSerializer() {
        return LeatherworkRecipeSerializer.INSTANCE;
    }
